...
<div class="container-fluid" style="margin-top:40px;">
    ...
    <div class="row ">
        ...
        <h1 style="color: #484848;"> <a href="dashboard.php " style="color:grey">DASHBOARD</a>  <b>/</b>  VEGETABLE'S</h1> 
        </div>
                ...
                <div class="row justify-content-between">
                     ...
                     <table class="table  table-hover">
                        <thead class="" style="color:white; background-color: #100e0e; ">
                          ...
                          <tbody style="">
                            <?php include 'db.php';
                           $sql = "SELECT * FROM product p JOIN sub_category sc ON p.sub_category = sc.subcat_id WHERE p.category = 2 ";
