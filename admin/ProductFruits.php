...
<div class="container-fluid" style="margin-top:40px;">
    ...
    <div class="row ">
        ...
        <h1 style="color: #484848;"> <a href="dashboard.php " style="color:grey">DASHBOARD</a>  <b>/</b>  FRUIT'S</h1> 
        </div>
        ...
        <div class="  col-sm-12 col-md-12 col-lg-12 "  style="height:100%; padding-bottom:50px;">
                     ...
                     <table class="table  table-hover">
                        <thead class="" style="color:white; background-color: #100e0e; ">
                          ...
                          <tbody style="">
                            <?php include 'db.php';
                           $sql = "SELECT * FROM product p JOIN sub_category sc ON p.sub_category = sc.subcat_id WHERE p.category = 1 ";
